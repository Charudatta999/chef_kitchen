...
namespace LinkedList
{
    ...
    {   
        ...
        public:
            DoublelyLinkedList();
            ~DoublelyLinkedList();
            bool AddNode(int key, const std::string& val);              // done
            bool AddNode(int key, const std::string& val, int positon); // done
            DoubleLL* AddNodeFront(int key, const std::string& val);    // done
